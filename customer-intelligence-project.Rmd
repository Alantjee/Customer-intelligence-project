...
With regards to the numbers of the dependents, we see that the median stands at two for both attrited and existing customers, whereas the mean is higher for the former (2.41 vs. 2.33). The first quantile is two for the attrited customers and one for the existing ones. Both shows same minimum (0), third quantile (3) and maximum (5). Interestingly, the boxplot of the attrited customers sees two outliers on the opposite sides and shows a asymetric distribution.
...
Concerning the age of the customers, we see that attrited customers show an average age slighly older than existing customers (46.66 vs. 46.26). Both see their minimum at 26, with the first quartile standing at 41 and the third at 52. Whereas the median for the attrited customers is higher (47 vs. 46), we see the maximum in the existing customers (73 vs. 68). Two outliers are present in the existing customer boxplot.

The average number of products held by the attrited customers is 3.28, whereas for existing customers is 3.92. As highly expected, the minimum in both cases stands at 1 and the maximum at 6. Whereas they show the same value for the third quartile (5), they have a slightly different first quartile: 2 for attrited customers and 3 for existing customers. The median is one unit higher in the existing customers group compare to the attrited customer one (4 vs 3). In the last boxplot is a greater amount of dispersion, meaning that there is a greater frequency of medium-high values.
...
The boxplot above shows the total transaction amount of both attrited and existing customers. The former show a mean of 44.93 transactions, whereas the latter 68.67. Also the maximum and the maximun are higher in the existing customers, being them respectively 139 versus 94 and 11 versus 10. The median is 43 for the attrited customers and 71 for the existing ones. Generally, the boxplot of the attrited customers show smaller values compared to the one of the existing customers, which is also underpinned by the lower amount in the first quartile (37 vs 54) and in the third quartile (51 vs 82).

With regards to the average card utilization ratio, we see how the two groups differ; median is 0% for the attrited customers, whereas it stands 21% for the existing ones. Although the maximum is 99% for both of them, the third quartile stands at 23% for the attrited customers ad 53% for the existing ones. The two boxplots present an asymmetric distribution, but the first present an increadibly high number of outliers.
